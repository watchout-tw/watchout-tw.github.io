    ...
    sections: [ // 這個陣列包含這一期草報的每個區塊
      {
        ...
        name: '中正紀念堂轉型給問嗎',
        title: '中正紀念堂轉型', // 區塊標題
        description: '為了擴大民意蒐集，加開3場願景工作坊<br>文化部於2017年7月啟動中正紀念堂轉型的社會討論計畫，將以「審議式民主公民討論」的方式進行，委託「沃草」團隊籌辦。透過充分的資訊提供，建構多元的討論方式，蒐集民眾對於中正紀念堂轉型的反思與發想，從中凝聚社會共識。', // 區塊文字
        articles: [ // 連結們
          {
          ...
          },
          {
            ...
            text: [ // 連結附加文字，分行
              '作者：本站由沃草團隊執行、製作，網站的資訊包含過去威權統治時期的制度與事件、國家不當暴力的受害者、中正紀念堂的介紹，以及其他國家如何進行轉型正義、處理獨裁者象徵等案例。',
            ],
          },
        ],
      },
